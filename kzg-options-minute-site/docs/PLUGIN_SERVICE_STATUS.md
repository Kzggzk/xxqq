...
| Browser / Playwright / Chrome | Active for QA | Used local browser automation and headless Chrome/CDP to verify v1.40 desktop/mobile viewports, no horizontal overflow, no public risk terms, and PNG export `/tmp/kzg-option-house-v140-export.png`. | Continue using for visual proof before deploy. Screenshots are QA evidence, not committed artifacts unless explicitly requested. |
