...
|---|---|---|---|
| GitHub | Active | Source and docs are pushed on branch `feat/kzg-option-house-daily-auto`. Latest pushed backup before v1.40 was `3e3f02e tighten option house mobile chrome v139`; v1.40 source/docs are the next backup commit. | Keep committing source/docs only. Do not commit raw generated data under `public/data/`, `public/reports/`, `.private/`, `dist/`, or raw `.csv.gz`. |
