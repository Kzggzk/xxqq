...
- Latest local verified version / 最近本地验证版本: `1.70` Web momentum queue compass
- Latest production verified version / 最近生产验证版本: `1.68`
- iOS companion / iOS 伴生版本: `0.7` native SwiftUI scaffold at `/Users/fangbao/kzg-options-minute-site/ios/KZGOptionHouse`
- Latest production correction / 最近生产修正: `v1.68 rotation-to-symbol handoff production deploy`
- Latest local restructure / 最近本地重构: `v1.70 Web momentum queue capital/CP/active-row compass`
- Latest unique deploy verified / 最近验证唯一部署: <https://6a16acc1dbce120ee54cac50--kzg-option-house.netlify.app/>
