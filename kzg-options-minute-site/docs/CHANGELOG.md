...
- Latest local verified version / 最近本地验证版本: `1.66` Web bucket-to-rotation handoff bridge
- Latest production verified version / 最近生产验证版本: `1.63`
- iOS companion / iOS 伴生版本: `0.6` native SwiftUI scaffold at `/Users/fangbao/kzg-options-minute-site/ios/KZGOptionHouse`
- Latest production correction / 最近生产修正: `v1.63 open-history path production deploy`
- Latest local restructure / 最近本地重构: `v1.66 bucket-risk to symbol-rotation handoff bridge inside the open historical layer`
