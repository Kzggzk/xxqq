...
- Latest local verified version / 最近本地验证版本: `1.59` Web three-sector spine and public-provider scrub; public Web production remains `1.56`
- Latest production verified version / 最近生产验证版本: `1.56`
- iOS companion / iOS 伴生版本: `0.5` native SwiftUI scaffold at `/Users/fangbao/kzg-options-minute-site/ios/KZGOptionHouse`
- Latest production correction / 最近生产修正: `v1.56 realtime flow-book production deploy`
- Latest local restructure / 最近本地重构: `v1.59 three-sector product spine and public source label cleanup`
- Latest unique deploy verified / 最近验证唯一部署: <https://6a15c1b6531adb3fd145e39d--kzg-option-house.netlify.app/>
