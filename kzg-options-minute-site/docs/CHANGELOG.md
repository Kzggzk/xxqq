...
- Latest local verified version / 最近本地验证版本: `1.67` iOS companion bucket-to-rotation handoff sync
- Latest production verified version / 最近生产验证版本: `1.63`
- iOS companion / iOS 伴生版本: `0.7` native SwiftUI scaffold at `/Users/fangbao/kzg-options-minute-site/ios/KZGOptionHouse`
- Latest production correction / 最近生产修正: `v1.63 open-history path production deploy`
- Latest local restructure / 最近本地重构: `v1.67 iOS companion sync for the bucket-risk to symbol-rotation handoff`
- Latest unique deploy verified / 最近验证唯一部署: <https://6a168b3efbed57514f5fc1ea--kzg-option-house.netlify.app/>
