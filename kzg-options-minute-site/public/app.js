...
const copy = {
  zh: {
    ...
    missing: "无交易/未落地",
    reportCanvas: "日报画布",
    reportCanvasSub: "网页可交互，PNG 导出沿用 KZG 日报表格样式。",
    digest: "盘口摘要",
  ...
  en: {
    ...
    reportCanvasSub: "The page stays interactive; PNG exports keep the KZG report-sheet layout.",
  ...
  target.innerHTML = `
    <div class="realtime-topline">
      <div class="realtime-heading">
        <span>${state.lang === "zh" ? "最新交易日" : "Latest session"}</span>
